...
<section class="site-cover" style="background-image: url({{url('/')}}/client/images/bg_3.jpg);" id="section-home">
    <div class="container">
        ...
        <div class="col-md-12">
            ...
            <p><a href="https://colorlib.com/" target="_blank" class="btn btn-outline-white btn-lg site-animate" data-toggle="modal" data-target="#reservationModal">Đặt bàn</a></p>
        </div>
        </div>
    </div>
</section>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-12">
              <div class="bg-image" style="background-image: url({{url('/')}}/client/images/reservation_1.jpg);"></div>
            </div>
